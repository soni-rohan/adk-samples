...
2. Edit `env.sh` and configure all the variables. Instructions can be found on the [ENVinstructions](https://github.com/soni-rohan/adk-samples/blob/main/python/agents/gcp-asset-retriever/ENVinstructions.md) file.
